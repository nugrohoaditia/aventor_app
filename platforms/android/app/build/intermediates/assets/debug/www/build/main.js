...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_http__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_http__ = __webpack_require__(152);
...
var LoginPage = /** @class */ (function () {
    function LoginPage(http, navCtrl, navParams, loadingCtrl, alertCtrl, toastCtrl) {
        this.http = http;
        this.navCtrl = navCtrl;
    ...
    LoginPage.prototype.login = function () {
        ...
        console.log(headers);
        return this.http.post('http://52.77.4.24/dev/arventor/login/ajax_login_app/', data, headers)
            .then(function (data) {
            console.log(data);
            ...
            _this.loading.dismiss();
            _this.showAlert("Mohon cek kembali username dan password anda.");
        });
    ...
    LoginPage.prototype.loginSuccessToast = function () {
